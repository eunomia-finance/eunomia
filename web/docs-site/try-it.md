...
2. **Set the rules and create — one signature.** The treasury holds **USDC** (funded with
   ...
   ![Setup: what the treasury holds, the two limits, a first payee, one button](https://raw.githubusercontent.com/eunomia-finance/eunomia/main/docs/screenshots/setup.png)
...
3. **Add funds with TRY** — on **Overview**, *Add funds* → type an amount (50–3000 TRY) and
   ...
   ![Add funds with TRY: the locked amount and the bank details](https://raw.githubusercontent.com/eunomia-finance/eunomia/main/docs/screenshots/add-funds-try.png)
...
6. **Now watch the real show** — try an amount **over** your per-payment limit, or a payment
   ...
   ![Overview: the latest decision blocked, the ledger of allowed and blocked payments, the budget meter, the Leash](https://raw.githubusercontent.com/eunomia-finance/eunomia/main/docs/screenshots/overview.png)
...
7. **Hand it to an agent (no more popups)** — on **Agent**:
   ...
   *Revoke Leash* takes control back instantly.
   ...
   ![Agent: an active Leash with its cap and countdown, and the command to connect an external agent](https://raw.githubusercontent.com/eunomia-finance/eunomia/main/docs/screenshots/agent-leash.png)
...
- Main [README](https://github.com/eunomia-finance/eunomia/blob/main/README.md) — architecture, contracts, the ZK confidential mode
- [The anchor leg](/anchor) — how TRY becomes a spendable agent budget, with evidence
- [`eunomia-mcp`](/connect-your-agent) — every tool the agent gets
